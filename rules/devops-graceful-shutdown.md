...
impact: MEDIUM-HIGH
tags: graceful-shutdown,lifecycle,kubernetes
---

## Implement Graceful Shutdown

Full rule with NestJS examples at: https://github.com/Kadajett/agent-nestjs-skills/blob/main/rules/devops-graceful-shutdown.md
