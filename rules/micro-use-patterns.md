...
impact: MEDIUM
tags: microservices,message-pattern,event-pattern
---

## Use Message and Event Patterns Correctly

Full rule with NestJS examples at: https://github.com/Kadajett/agent-nestjs-skills/blob/main/rules/micro-use-patterns.md
