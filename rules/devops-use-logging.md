...
impact: MEDIUM-HIGH
tags: logging,structured-logs,pino
---

## Use Structured Logging

Full rule with NestJS examples at: https://github.com/Kadajett/agent-nestjs-skills/blob/main/rules/devops-use-logging.md
