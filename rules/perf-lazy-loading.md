...
impact: MEDIUM
tags: lazy-loading,modules,optimization
---

## Use Lazy Loading for Large Modules

Full rule with NestJS examples at: https://github.com/Kadajett/agent-nestjs-skills/blob/main/rules/perf-lazy-loading.md
