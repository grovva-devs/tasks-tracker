...
impact: HIGH
tags: database,queries,drizzle,optimization
---

## Optimize Database Queries

Full rule with NestJS examples at: https://github.com/Kadajett/agent-nestjs-skills/blob/main/rules/perf-optimize-database.md
